...
class TestView(TestCase):
    ...
    def navbar_test(self, soup):
        ...
        self.assertIn('어바웃 미', navbar.text)

        logo_btn=navbar.find('a', text='두잇장고')
        ...
        about_me_btn=navbar.find('a', text='어바웃 미')
    ...
    def test_post_detail(self):
        ...
        # 2.1. 첫 번째 포스트의 url로 접근하면 정상적으로 작동한다(sttus code : 200).
        ...
        # 2.6. 첫 번째 포스트의 내용(contnet)이 포스트 영역에 있다.
